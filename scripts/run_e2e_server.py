...
def main() -> None:
    ...
    allowed = {f"sqlite:///data/{name}" for name in ("public-e2e.db", "levels-e2e.db", "level-drag-e2e.db", "arrangement-e2e.db", "grid-e2e.db", "grid-edit-e2e.db", "grid-axis-e2e.db", "grid-interaction-e2e.db", "grid-cell-shade-e2e.db", "grid-undo-e2e.db", "grid-header-e2e.db", "grid-panels-e2e.db", "grid-export-e2e.db", "grid-recovery-e2e.db", "grid-shade-e2e.db", "grid-menu-e2e.db", "grid-redo-20260923-e2e.db", "grid-redo-20260923-r2-e2e.db", "grid-redo-20260923-orch-e2e.db", "grid-redo-20260923-final-e2e.db", "grid-redo-20260923-final2-e2e.db", "grid-redo-20260923-final3-e2e.db", "grid-redo-20260923-locator-e2e.db", "grid-redo-20260923-acceptance-e2e.db", "grid-redo-20260923-final-visual-e2e.db", "grid-redo-20260923-contrast-e2e.db", "grid-save-tail-repro-20260923-e2e.db", "grid-save-tail-final-20260923-e2e.db", "comp-levels-release-0.2.0-a-e2e.db", "comp-levels-release-0.2.0-a2-e2e.db", "comp-levels-release-0.2.0-a3-e2e.db", "comp-levels-release-0.2.0-b-e2e.db", "comp-levels-release-0.2.0-b2-e2e.db", "comp-levels-release-0.2.0-b3-e2e.db", "comp-levels-release-0.2.0-c-e2e.db", "comp-levels-release-0.2.0-c2-e2e.db", "comp-levels-release-0.2.0-c3-e2e.db", "comp-levels-release-0.2.0-c4-e2e.db", "comp-levels-release-0.2.0-c5-e2e.db", "comp-levels-release-0.2.0-c6-e2e.db")}
